...
void loop() {
  ...
  Serial.print("Enable DSG: ");
  Serial.println(bmic.enableDischarging());
  
  Serial.println("Cells: ");
  Serial.println(bmic.getCellVoltage(1));
  Serial.println(bmic.getCellVoltage(2));
  Serial.println(bmic.getCellVoltage(3));
  Serial.println(bmic.getCellVoltage(4));
  Serial.println(bmic.getCellVoltage(5));
  Serial.println();


  Serial.print("Status: ");
  Serial.println(bmic.checkStatus());
  Serial.println();
